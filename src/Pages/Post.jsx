        ...
        <StDiv>
          <StList>
            ...
            <input
              type="file"
              placeholder="PICTURE"
              onChange={(e) => saveFileImage(e, logoImgRef, setFileImage)}
              required
            />
          </StList>
          <StList>
            ...
            <input
              type="text"
              placeholder="장소 예) 영등포점"
              maxLength={10}
              ref={locationRef}
            />
            <input
              type="number"
              placeholder="전화번호 예) 07012345678"
              maxLength={11}
              ref={phoneRef}
            />
            <input
              type="text"
              placeholder="오프시간 예) 오전11시"
              maxLength={6}
              ref={openingHoursRef}
            />
            <input
              type="text"
              placeholder="최소 주문 금액 예) 20000"
              maxLength={7}
              ref={minPriceRef}
            />
          </StList>
          ...
          <StList>
            <input
              type="file"
              placeholder="PICTURE"
              onChange={(e) => saveFileImage(e, menuImgRef, setMenuOne)}
              required
            />
            <input
              type="text"
              placeholder="메뉴 이름(최대10자)"
              maxLength={15}
              ref={menuNameRef}
            />
            <input
              type="number"
              placeholder="가격 예) 30000"
              maxLength={6}
              ref={priceRef}
            />
            <input
              type="text"
              placeholder="설명 (최대20자)"
              maxLength={20}
              ref={explainRef}
            />
          </StList>
          ...
          <StList>
            <input
              type="file"
              placeholder="PICTURE"
              onChange={(e) => saveFileImage(e, twomenuImgRef, setMenuTwo)}
              required
            />
            <input
              type="text"
          ...
          <StList>
            <input
              type="file"
              placeholder="PICTURE"
              onChange={(e) => saveFileImage(e, threemenuImgRef, setMenuThree)}
              required
            />
            <input
              type="text"
