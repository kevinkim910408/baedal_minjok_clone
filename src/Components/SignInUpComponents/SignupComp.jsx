...
import { passwordRegCheck, emailRegCheck, idRegCheck } from '../../Shared/LoginCheck'
  ...
  return (
    <>
      <StWrap>
          ...
          {passwordRegCheck(pw) ? <p className='pass'>형식에 맞는 비밀번호 입니다.</p> : <p className='danger'> 영문+숫자 8-20자로 만들어 주세요.</p>}
